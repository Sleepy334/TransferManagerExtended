...
namespace TransferManagerCore
{
    ...
    public class ResidentAIUpdateWorkplace
    {
        ...
        public static bool UpdateWorkplacePrefix(uint citizenID, ref Citizen data)
        {
            ...
            {
#if DEBUG
                //Log.Info($"Invalid citizen: {citizenID} All 0");
#endif
                return false;
            }
...
#if DEBUG
                //Log.Info($"Invalid citizen: {citizenID} @Home, HomeBuilding:{data.m_homeBuilding} MovingIn:{(data.m_flags & Citizen.Flags.MovingIn) != 0}");
#endif
                return false;
            }
