...
namespace TransferManagerCore
{
    ...
    public class DistrictSelectionPatches
    {
        ...
        [HarmonyPostfix]
        public static void AddDistrictColor2Postfix(byte district, Policies policy, byte alpha, bool inArea, ref Color32 color2)
        {
        ...
        public static void UpdateDistricts()
        {
            ...
            {
                HashSet<DistrictData> allowedDistricts = DistrictSelectionPanel.Instance.GetAllowedDistricts();
