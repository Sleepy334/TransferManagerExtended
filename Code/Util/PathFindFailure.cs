...
namespace TransferManagerCore.Util
{
    ...
    public sealed class PathFindFailure
    {
        ...
        {
            if (s_pathCounterLock is not null)
            {
        ...
        {
            if (s_pathfindFails is not null)
            {
                lock (s_dictionaryLock)
                {
        ...
        {
            if (s_outsideConnectionFails is not null)
            {
                lock (s_dictionaryLock)
                {
        ...
        public static void Reset()
        {
            ...
            if (s_pathfindFails is not null && s_outsideConnectionFails is not null)
            {
                lock (s_dictionaryLock)
                {
                    if (s_pathfindFails is not null)
